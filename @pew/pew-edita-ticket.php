...
<html>
    ...
    <body>
        ...
        <section class="conteudo-painel">
                                            ...
                                            function fechar(){
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function(response){
                                                        ...
                                                        if(response == "true"){
                                                            window.location.href = "pew-tickets.php";
                                                        }else{
                                                            mensagemAlerta("Ocorreu um erro ao fechar o ticket.");  
                                                        }
                                                    }
            ...
            $ticketID = isset($_GET["id_ticket"]) ? addslashes($_GET["id_ticket"]) : null;
            ...
            $showTicket = $ticketID != null && $infoTotal["total"] > 0 ? true : false;
            ...
            if($showTicket){
                ...
                $query = mysqli_query($conexao, "select * from tickets_register where id = '$ticketID'");
            ...
            <div class="display-ticket">
                ...
                <div class="ticket-content">
                    <div class="message-field">
                        ...
                        <form class="ticket-message" method="post" action="pew-update-ticket.php" enctype="multipart/form-data">
            ...
            <?php
                ...
                echo "<div align=center><a href='pew-tickets.php' class='link-pa
                drao'>Voltar</a></div>";
            }
            ?>
        </section>
