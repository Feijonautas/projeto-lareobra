    ...
    <body>
        <?php
            ...
            if($totalUsuario > 0){
				...
				$idFranquia = $arrayUsuario["id_franquia"];
...
<?php
					...
					echo "<center><br><br><h3 align=center>Você não tem permissão para alterar este usuário</h3>";
					echo "<br><a href='pew-usuarios.php' class='link-padrao'>Voltar</a></center>";
				}
            }else{
