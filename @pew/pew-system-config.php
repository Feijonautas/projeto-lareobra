<?php
    ...
    $pew_db = new Pew_Data_Base("xmysql1.lareobra.com.br", "lareobra1", "admlareobra@123", "lareobra1", "pew_banners", "pew_categorias", "pew_subcategorias", "pew_contatos", "pew_usuarios_administrativos");
